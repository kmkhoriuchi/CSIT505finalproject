...
for line_str in in_file1:
    ...
    for elem in range(len(temp_list)):
        episode4_line[elem] = temp_list[elem].translate(str.maketrans('', '', string.punctuation))
        ...
        if elem == 2:
            ...
            for i in range(len(episode4_line[elem])):    
                if episode4_line[elem][0].isupper() and episode4_line[elem][1].isupper():
...
for line_str in in_file2:
    ...
    for elem in range(len(temp_list)):
        episode5_line[elem] = temp_list[elem].translate(str.maketrans('', '', string.punctuation))
        ...
        if elem == 2:
            ...
            for i in range(len(episode5_line[elem])):    
                if episode5_line[elem][0].isupper() and episode5_line[elem][1].isupper():
...
for line_str in in_file3:
    ...
    for elem in range(len(temp_list)):
        episode6_line[elem] = temp_list[elem].translate(str.maketrans('', '', string.punctuation))
        ...
        if elem == 2:
            ...
            for i in range(len(episode6_line[elem])):    
                if episode6_line[elem][0].isupper():
